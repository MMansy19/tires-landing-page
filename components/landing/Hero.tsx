      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <div className="w-20 h-1 bg-accent mb-6 mx-auto" />

            <p className="text-base md:text-xl text-slate-200 mb-8 max-w-2xl mx-auto leading-relaxed">
              {t('description')}
            </p>
            ...
            <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-white/10 pt-6 sm:pt-8 max-w-3xl mx-auto">
